 ...
 */
public class LifecycleCall extends OnyxEntity
{
	protected static String coerceKw = OnyxLifecycleCall;
	 ...
	 * @param  LifecycleCall c             existing map to use for new
	 *                                     LifecycleCall
	 * @return           new LifecycleCall object
	 */
	private LifecycleCall(LifecycleCall c) {
    	super(c.entry);
	}

	/**
	 * Coerces LifecycleCall object content map into proper onyx LifecycleCall.
